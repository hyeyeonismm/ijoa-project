  ...
  return (
    ...
    <div style={{width: 451, height: 123, left: 44, top: 332, position: 'absolute'}}>
        <div style={{width: 451, height: 92, left: 0, top: 0, position: 'absolute'}}>
            ...
            <div style={{width: 302, height: 19, left: 25, top: 54, position: 'absolute', color: '#ABABAB', fontSize: 18, fontFamily: 'DM Sans', fontWeight: '400', wordWrap: 'break-word'}}>비밀번호</div>
        </div>
        <div style={{left: 365, top: 105, position: 'absolute', color: 'rgba(173, 49, 19, 0.80)', fontSize: 14, fontFamily: 'DM Sans', fontWeight: '400', wordWrap: 'break-word'}}>비밀번호 찾기</div>
    </div>
    <div style={{width: 451, height: 474, left: 44, top: 71, position: 'absolute'}}>
        <div style={{width: 22, height: 19, left: 410, top: 301, position: 'absolute'}}>
            <div style={{width: 22, height: 12.11, left: 0, top: 3.45, position: 'absolute', background: '#8E8E8E'}}></div>
            <div style={{width: 8.70, height: 7.52, left: 6.65, top: 5.74, position: 'absolute', background: '#8E8E8E'}}></div>
        </div>
